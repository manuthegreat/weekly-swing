...
# GOLDEN SOURCE — logic preserved exactly
# ------------------------------------------------------------
...
UNIVERSE_RULES = {
    "HK": dict(mcap_min=5e9, mcap_max=80e9, adv_turnover_20_min=100e6),
    "US": dict(mcap_min=2e9, mcap_max=150e9, adv_turnover_20_min=75e6),
    "SG": dict(mcap_min=1e9, mcap_max=80e9, adv_turnover_20_min=10e6),
}
